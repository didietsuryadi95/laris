...
class TaxExclusiveOfferDiscount(methods.TaxExclusiveOfferDiscount):
    ...
    def calculate(self, basket):
        result = {
            'price': '',
            'price_before_shipping_discount': '',
            'discount': '',
            'estimate': '',
            'error': ''
        }
        ...
        result_method['price_before_shipping_discount'] = prices.Price(currency=base_charge.currency,
                                                                       excl_tax=base_charge.excl_tax)
        discount = int(self.offer.shipping_discount(base_charge.excl_tax))
        result_method['discount'] = discount
    ...
    def discount(self, basket):
        ...
        return int(self.offer.shipping_discount(base_charge.excl_tax))
...
class TaxInclusiveOfferDiscount(methods.TaxInclusiveOfferDiscount):
    ...
    def calculate(self, basket):
        ...
        result_method['price_before_shipping_discount'] = prices.Price(currency=base_charge.currency,
                                                                       excl_tax=self.calculate_excl_tax(base_charge,
                                                                                                        base_charge.incl_tax),
                                                                       incl_tax=base_charge.incl_tax)
        discount = int(self.offer.shipping_discount(base_charge.incl_tax))
        result_method['discount'] = discount
    ...
    def discount(self, basket):
        ...
        return int(self.offer.shipping_discount(base_charge.incl_tax))
