...
var oscar = (function (o, $) {
    ...
    o.report = {
        init: function () {
            const order_number_field = $('#id_order_number'),
                    order_number_label = $('label[for="id_order_number"]'),
                    report_type_field = $('#id_report_type');
            const check_report_type = function(){
                if(report_type_field.val() !== 'withdrawal_report') {
