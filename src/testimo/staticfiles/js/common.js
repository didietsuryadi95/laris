...
$('.input-date-icon').click(function (e) {
    let elementID = $(this).data("id");
    $(`#${elementID}`).datetimepicker('show'); //support hide,show and destroy command
});
...
$(".open-modal").click(function (e) {
    ...
    if (gdnModal.hasClass("open")) {
        ...
        gdnModal.find(".gdn-modal-content").addClass("active");
        $(idContent).show();
        if (bodyContent) {
...
$("a.open-filter-mobile").click(function (e) {
    ...
    $('body').addClass("overflow-no-scroll");
    $(".header-logo > a.btn").addClass("filter-mobile-close");
    sortElement.show();
...
$("a.open-account-mobile.home").click(function (e) {
    e.preventDefault();
