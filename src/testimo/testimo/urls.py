...
urlpatterns = [
    ...
    path('payment/<slug:order_number>/notification/', payment_notifications, name='payment-notification'),
    path('payment/<slug:order_number>/response/', payment_response, name='payment-response'),
