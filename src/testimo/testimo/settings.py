"""
Django settings for testimo project.
...
WSGI_APPLICATION = 'testimo.wsgi.application'
...
LOGGING = {
    ...
    'formatters': {
        ...
        'standard': {
            ...
            f"testimoOfficial.com E-COMMERCE [%(asctime)s] %(levelname)s [%(name)s:%(lineno)s] %(message)s",
            'datefmt': "%d/%b/%Y %H:%M:%S"
        },
        'verbose': {
...
ADMINS = [
    ('testimo error', env.string('DEBUG_EMAIL', 'error.testimo@staff.gramedia.com')),
]
...
DATABASES = {
    'default': env.django_db('DB_URI_PASS', 'postgresql://testimo:p@ssw0rd24@localhost:5432/testimo')
}

HAYSTACK_CONNECTIONS = {
    'default': {
        'ENGINE': 'haystack.backends.solr_backend.SolrEngine',
        'URL': 'http://' + env.string('SOLR_HOST', '127.0.0.1') + ':8983/solr/testimo',
        'TIMEOUT': 60 * 5,
...
BANNER_MINI_PLACEHOLDER = {
    ...
    'url': 'https://testimo.com/',
    'description': 'default mini banner',
    'published': True
}

# T'estimo by Sari Batubara Social Media
SOCIAL_INSTAGRAM = 'https://www.instagram.com/testimo_bysb/'
SOCIAL_FACEBOOK = ''
SOCIAL_TWITTER = ''
SOCIAL_YOUTUBE = ''
...
KGX_ORIGIN_ZIP_CODE = env.string('KGX_ZIP_CODE', '12510')
...
META_SITE_DOMAIN = 'testimobysb.com'
