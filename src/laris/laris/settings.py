"""
Django settings for laris project.
...
env_prefix = os.getenv('APP_ENV_PREFIX', 'TES')

env = EnvConfig(env_prefix)

SITE_ID = 1

WSGI_APPLICATION = 'laris.wsgi.application'
...
SECRET_KEY = "TES4@4!@v6)y5anurvf-3#ona@ds^dvg&ul577=q1m)c%xuf^lm#stes"
...
LOGGING = {
    ...
    'formatters': {
        ...
        'standard': {
            ...
            f"larisOfficial.com E-COMMERCE [%(asctime)s] %(levelname)s [%(name)s:%(lineno)s] %(message)s",
            'datefmt': "%d/%b/%Y %H:%M:%S"
        },
        'verbose': {
...
ADMINS = [
    ('laris error', env.string('DEBUG_EMAIL', 'error.laris@staff.gramedia.com')),
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'laris.context_processors.global_settings',
            ],
        },
    },
]
...
DATABASES = {
    'default': env.django_db('DB_URI_PASS', 'postgresql://laris:p@ssw0rd24@localhost:5432/laris')
}

HAYSTACK_CONNECTIONS = {
    'default': {
        'ENGINE': 'haystack.backends.solr_backend.SolrEngine',
        'URL': 'http://' + env.string('SOLR_HOST', '127.0.0.1') + ':8983/solr/laris',
        'TIMEOUT': 60 * 5,
...
OSCAR_SHOP_NAME = "Laris by Sari Batubara"
OSCAR_SHOP_TAGLINE = "LarisBySB.com"
...
OSCAR_FROM_EMAIL = 'no-reply@laris.com'
OSCAR_TO_EMAIL = SERVER_EMAIL = ''
...
# T'estimo by Sari Batubara Social Media
SOCIAL_INSTAGRAM = 'https://www.instagram.com/laris_bysb/'
SOCIAL_FACEBOOK = ''
SOCIAL_TWITTER = ''
SOCIAL_YOUTUBE = ''
...
KGX_API_URL = env.string('KGX_API_URL', 'https://test-api.kgx.co.id/apiv2')
...
SHIPPING_SENDER = {
    'name': "Laris By Sari Batubara",
    'mobile': PARTNER_PHONE_NUMBER,
    'email': PARTNER_EMAIL,
}

SHIPPING_ORIGIN = {
    'address': 'Jl. Condet Pejaten No 11, RT 002 RW 007, Kelurahan Pejaten Barat, Kecamatan Pasar Minggu',
